...
public class EastHttpReq {
    ...
    private static   Map<String,String> headerMap = new LinkedHashMap<>();
     ...
     */
    @Info(info = "封装请求头信息使用HashMap")
    public Connection getConnection(String url,Map<String,String> headerMap) {
     ...
     * @return jsoup封装的连接
     */
    public Connection getConnectionUniversal(String url,Map<String,String> headerMap){
        connection = Jsoup.connect(url);
        connection.headers(headerMap);
        return connection;
    }
     ...
     * @return 返回一个常规化的文档
     */
    public Document getDocument (String url,Map<String,String> headerMap){
        try {
     ...
     * @return 返回一个特殊化的文档
     */
    public Document getUniversalDocument (String url,Map<String,String> headerMap){
        try {
    ...
    public  String getJson(String reqUrl) throws IOException {
     ...
     */
    @Info(info = "除非你调用的是接口直接返回的是JSON，否则不建议使用此方法")
    public  String getJsonUniversal(String reqUrl,Map<String,String> headerMap) throws IOException {
     ...
     * @return 返回自动转换后的文档
     */
    public  Document parseResponse(String responseStr){
